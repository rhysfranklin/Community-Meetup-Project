...
public class ScheduleService {
    ...
    public void scheduleFollowUpMessage() throws Exception {
        ...
        if(optMessageId.isPresent()){
            ...
            String message = numberOfInteractions + " people are interested in attending this months event. Please would he organiser for the next event propose a date for the event using the slack shortcut command /schedule-event ";
